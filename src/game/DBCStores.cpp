...
void LoadDBCStores(const std::string& dataPath)
{
    ...
    const uint32 DBCFilesCount = 108;
    ...
    LoadDBC(availableDbcLocales,bar,bad_dbc_files,sGtSpellScalingStore,     dbcPath,"gtSpellScaling.dbc");
    ...
    LoadDBC(availableDbcLocales,bar,bad_dbc_files,sItemCurrencyCostStore,    dbcPath,"ItemCurrencyCost.dbc");
    ...
    // HACK for map 0, data removed in 4.0
