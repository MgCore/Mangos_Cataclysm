...
enum Opcodes
{
    ...
    SMSG_CHARACTER_LOGIN_FAILED                      = 0x07ACC, // 31436 - 4.0.6.13623
    ...
    CMSG_LOGOUT_CANCEL                               = 0x039EB, // 4.0.6a 13623
    ...
    CMSG_AUTOSTORE_GROUND_ITEM                       = 0x02FC8, // 12232 - 4.0.6.13623
    ...
    SMSG_QUESTGIVER_QUEST_LIST                       = 0x02B88, // 11144 - 4.0.6.13623
    ...
    SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT              = 0x0EDA4, // 60836 - 4.0.6.13623
    ...
    CMSG_SET_PRIMARY_TALENT_TREE                     = 0x0FEA8, // 65192 - 4.0.6.13623
    ...
    CMSG_REQUEST_PARTY_MEMBER_STATS                  = 0x070C8, // 28872 - 4.0.6.13623
    ...
    CMSG_CANCEL_GROWTH_AURA                          = 0x0FECC, // 65228 - 4.0.6.13623
    ...
    SMSG_BATTLEFIELD_STATUS                          = 0x0454C, // 4.0.6a 13623
    ...
    CMSG_MINIGAME_MOVE                               = 0x0B2E4, // 45796 - 4.0.6.13623
    ...
    SMSG_SPELL_UPDATE_CHAIN_TARGETS                  = 0x036A4,  // 13988 - 4.0.6.13623
    ...
    CMSG_CANCEL_MOUNT_AURA                           = 0x064CC, // 25804 - 4.0.6.13623   //strawberry
    ...
    CMSG_SET_ACTIVE_VOICE_CHANNEL                    = 0x032A4, // 12964 - 4.0.6.13623
    ...
    CMSG_GET_MIRRORIMAGE_DATA                        = 0x0A08C, // 41100 - 4.0.6.13623
    ...
    CMSG_REQUEST_VEHICLE_EXIT                        = 0x0208C, // 8332  - 4.0.6.13623
    CMSG_REQUEST_VEHICLE_PREV_SEAT                   = 0x02DE4, // 11748 - 4.0.6.13623
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                   = 0x064E4, // 25828 - 4.0.6.13623
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                 = 0x0A8CC, // 43212 - 4.0.6.13623
    ...
    CMSG_DISMISS_CRITTER                             = 0x0B7CC, // 47052 - 4.0.6.13623
    ...
    CMSG_PLAYER_VEHICLE_ENTER                        = 0x02D77,  // 11639 - 4.0.3.13329, cmsg uint64
    CMSG_EJECT_PASSENGER                             = 0x0F688, // 63112 - 4.0.6.13623, uint64
    ...
    CMSG_ITEM_REFUND_INFO                            = 0x031E0, // 12768 - 4.0.6.13623
    ...
    SMSG_UNKNOWN_1301                                = 0x4F7F,  // 20351 - 4.0.3.13329, something with player movement (move event 58?)
    SMSG_UNKNOWN_1302                                = 0x1024E, //
    CMSG_UNKNOWN_1303                                = 0x06BE0, // 
    SMSG_UNKNOWN_1304                                = 0x02E5E, //
    SMSG_UNKNOWN_1305                                = 0x72E0,  // 29408 - 4.0.6.13623, something with player movement (move event 58?), speed packet
    UMSG_UNKNOWN_1306                                = 0x519,   // not found
    ...
    SMSG_UNKNOWN_1330                                = 0x865E,  // 34398 - 4.0.3.13329, some compressed packet?
