...
char serviceName[] = "gamestaticd";
char serviceLongName[] = "MaNGOS world static service";
...
extern int main(int argc, char **argv)
{
    ...
    char const* cfg_file = _GAMESTATICD_CONFIG;
    ...
    sLog.outString( "%s [gamestatic-daemon]", _FULLVERSION(REVISION_DATE,REVISION_TIME,REVISION_NR,REVISION_ID) );
